 ...
 * 
 * 	MBR and diameterRectangle can be different
 * 
 ...
 * @author sstein
 */
public class OrientationMBR /*extends JFrame*/{
                ...
                */                
                ...
                if ((dx != 0.0) || (dy!=0.0)){
                    ...
                    if (dx == 0.0) {angle = Math.acos(0.0);}
               	 	 ...
               	 	 */
                    tempGeom = (Geometry)this.myPolygon.clone();
    ...
    private void calcJtsDiameter() {
        ...
        Geometry tempGeom = (Geometry)this.myPolygon.clone();
    ...
    public void calcWHfromMBR(){
        ...
        Geometry tempGeom = (Geometry)myObject.clone();
