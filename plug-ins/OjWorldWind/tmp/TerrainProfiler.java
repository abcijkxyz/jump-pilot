 ...
 */
public class TerrainProfiler extends TmpApplicationTemplate
{
    @SuppressWarnings("unchecked")
    public static class AppFrame extends TmpApplicationTemplate.AppFrame
    {
    ...
    {
        ApplicationTemplate.start("World Wind Terrain Profiler", TerrainProfiler.AppFrame.class);
    }
}
