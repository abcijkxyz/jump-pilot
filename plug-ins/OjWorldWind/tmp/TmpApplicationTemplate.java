package org.nico.openjump.ojworldwind.ww;
 ...
 */
public class TmpApplicationTemplate
{
    ...
    public static class AppFrame extends JFrame
    {
        ...
        protected TmpApplicationTemplate.AppPanel wwjPanel;
            ...
            this.wwjPanel.getWwd().addRenderingExceptionListener(new RenderingExceptionListener()
            {
                public void exceptionThrown(Throwable t)
                {
                    if (t instanceof WWAbsentRequirementException)
                    {
                        ...
                        JOptionPane.showMessageDialog(TmpApplicationTemplate.AppFrame.this, message, "Unable to Start Program",
        ...
        protected TmpApplicationTemplate.AppPanel createAppPanel(Dimension canvasSize, boolean includeStatusBar)
        {
            return new TmpApplicationTemplate.AppPanel(canvasSize, includeStatusBar);
        }
        ...
        public TmpApplicationTemplate.AppPanel getWwjPanel()
        {
            return wwjPanel;
        }
    ...
    public static TmpApplicationTemplate.AppFrame start(String appName, Class appFrameClass)
    {
        ...
        try
        {
            final TmpApplicationTemplate.AppFrame frame = (TmpApplicationTemplate.AppFrame) appFrameClass.newInstance();
    ...
    public static void main(String[] args)
    {
        ...
        TmpApplicationTemplate.start("World Wind Application", TmpApplicationTemplate.AppFrame.class);
    }
}
