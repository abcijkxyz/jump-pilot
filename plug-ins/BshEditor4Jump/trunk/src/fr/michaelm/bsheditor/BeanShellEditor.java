    ...
    */
    private void initUI() {
        ...
        mainToolBar.add(clearOutputButton);
            clearOutputButton.addEventLink(CommandEvent.class, this, "clearOutput");
        mainToolBar.add(fontSizeLabel);
        mainToolBar.add(fontSizeChooser);
            fontSizeChooser.addEventLink(ValueChangedEvent.class, this, "changeFont");
        ...
        rightPanel.setOneTouchExpandable(true);
            ...
            southPanel = new BorderContainer();
                ...
                outputTextArea.setFont(new Font("Monospaced", Font.PLAIN, (Integer)fontSizeChooser.getSelectedValue()));
