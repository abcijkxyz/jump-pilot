...
public class TestColorGraph
{
   ...
   {
      SimpleGraph<String, String> simpleGraph = new SimpleGraph<String, String>(String.class);
      ...
      ColorGraph<String> nc = new ColorGraph<String>();

      Map<String, String> colorMap = nc.colorGraph(simpleGraph);

      verifyColors(simpleGraph, colorMap);

      SimpleGraph<String, String> simpleGraph2 = new SimpleGraph<String, String>(String.class);
