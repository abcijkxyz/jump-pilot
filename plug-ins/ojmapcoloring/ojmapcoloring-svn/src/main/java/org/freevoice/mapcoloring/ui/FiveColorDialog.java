...
//      bufferLabel.setToolTipText(StringManager.getString("dbquery.submit.query.to.database"));
//      bufferLabel.setText(StringManager.getString("dbquery.run.query"));
   ...
   class ColorTask extends SwingWorker<Void, Void>
   {
      ...
      private FiveColorMap<Feature> colorMap = new FiveColorMap<Feature>();
