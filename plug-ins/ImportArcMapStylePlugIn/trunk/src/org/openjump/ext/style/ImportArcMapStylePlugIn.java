//$HeadURL: https://svn.code.sf.net/p/jump-pilot/code/core/trunk/src/org/openjump/core/ui/plugin/style/ImportArcMapStylePlugIn.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class ImportArcMapStylePlugIn extends AbstractPlugIn {
    ...
    static ResourceBundle rb =
            ResourceBundle.getBundle("org.openjump.ext.style.language.jump");
    ...
    public void initialize(PlugInContext context) throws Exception {
        ...
        context.getFeatureInstaller().addMainMenuItem(this, new String[] { LAYER, STYLE },
                rb.getString("ImportArcMapStylePlugIn.name"), false, null, enableCheck);
    }
    ...
    private static File findArcMap2SLD(WorkbenchFrame wbframe, Blackboard bb) throws IOException, InterruptedException {
        ...
        if (am2sld == null || !am2sld.exists()) {
            showMessageDialog(wbframe,
                    ...
                    rb.getString("ImportSLDPlugIn.Question"), INFORMATION_MESSAGE);
            if (arcmap2sld != null) {
    ...
    public boolean execute(PlugInContext context) throws Exception {
        ...
        showMessageDialog(wbframe,
                rb.getString("ImportArcMapStylePlugIn.Must-Select-Location-Of-SLD"),
                rb.getString("ImportSLDPlugIn.Question"), INFORMATION_MESSAGE);
    ...
    public String getName() {
        return rb.getString("ImportArcMapStylePlugIn.name");
    }
